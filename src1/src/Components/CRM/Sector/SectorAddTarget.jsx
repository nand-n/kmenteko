...
import AddQuarterTarget from "./SectorAddQuarterTarget";
import AddYearlyTarget from "./SectorAddYearlyTarget";

export default function SectorAddTarget(props) {
          ...
          <div className="border-0 -lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            {registration === "Add Quarterly Target" ? (
              <div className="px-6 py-3">
                <AddQuarterTarget setAddTarget={props?.setAddTarget} />
              </div>
            ) : (
              <div className="px-6 py-3">
                <AddYearlyTarget setAddTarget={props?.setAddTarget} />
              </div>
            )}
          </div>
        </div>
