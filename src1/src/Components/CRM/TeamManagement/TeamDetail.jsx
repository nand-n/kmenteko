    ...
    <div className="">
      <div className="flex flex-row gap-5 items-center p-3">
        ...
        <div className="flex flex-col">
          <div className="text-sm text-[#A9ABA9]">Team Lead</div>
          <input
            type="text"
            id="vendor_name"
            class="text-[#000] bg-[#F5FAFD] p-1 border border-gray-300  text-sm"
            required
            value="Kiber Temaw"
          />
        </div>
      ...
      <div className="p-5">
        ...
        <select
          id="countries"
          class="border bg-[#F5FAFD] border-gray-300 text-gray-900 text-sm  p-2.5 w-full"
        >
